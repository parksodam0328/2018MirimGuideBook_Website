                    ...
                    <form name="form1" method="post" action="rule_check.php">
                        <div class="container2">
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input type="text" name="division_number" placeholder="구분번호">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                            ...
                            <div class="row">
                                <div class="col-25">
                                    <label for="country">규정내용</label>
                                </div>
                                <div class="col-75">
                                    <textarea name="content" placeholder="규정내용"></textarea>
                                </div>
							</div>
                            ...
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkRuleInput()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="rule_list.php">
