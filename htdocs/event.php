                ...
                <center>
                    <form name="form1" method="post" action="event_check.php">
                        <div class="container2">
                            <div class="row">
                                <div class="col-25">
                                    <label for="fname">행사명</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="event_name" placeholder="행사명">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
							...
							<div class="row">
                                ...
                                <div class="col-75">
                                    <input type="file" name="event_image" placeholder="약도 이미지">
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkEventInput()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="event_list.php">
