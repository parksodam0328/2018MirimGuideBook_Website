                ...
                <center>
                    <form name="form1" method="post" action="subject_check.php">
                        <div class="container2">
                            ...
                            <div class="row">
                                <div class="col-25">
                                    <label for="country">과목</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="name_sub" placeholder="과목">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="subject">과목 소개</label>
                                </div>
                                <div class="col-75">
                                    <textarea id="subject" name="intro_sub" placeholder="과목 소개" style="height:200px"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="subject">선생님 성함</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="teacher" placeholder="선생님 성함">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="subject">실습실 위치</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="room" placeholder="실습실 위치">
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkSubjectInput()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="subject_list.php">
