                ...
                <center>
                    <form name="form1" method="post" action="club_check.php">
                        <div class="container2">
                            <div class="row">
                                <div class="col-25">
                                    <label for="fname">구분번호</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="number" placeholder="구분번호">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="lname">동아리명</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="club_name" placeholder="동아리명">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="country">동아리실</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="club_room" placeholder="동아리실">
                                </div>
							</div>
							<div class="row">
                                <div class="col-25">
                                    <label for="subject">담당 교사</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="teacher" placeholder="담당 교사">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="subject">동아리 소개</label>
                                </div>
                                <div class="col-75">
                                    <textarea id="subject" name="intro" placeholder="동아리 소개" style="height:200px"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkClubInput()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="club_list.php">
