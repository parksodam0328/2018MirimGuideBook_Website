    ...
    <body>
        ...
        <div id="testimonials" class="testimonials-section">
            <h2 class="section-title text-center" style="text-transform: capitalize;font-family:'Paragon Cleaners Medium' !important;">
                <font color="#000">Experience</font>
            </h2>
                ...
                <center>
                    <form name="form2" method="post" action="experience_check2.php">
                        <div class="container2">
                            <div class="row">
                                <div class="col-25">
                                    <label for="fname">계열</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="major" placeholder="계열">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="lname">코딩연습<br>
											<font size="2px">(코드 입력시 결과도 같이 입력)</font></label>
                                </div>
                                <div class="col-75">
                                    <textarea name="coding" placeholder="코딩연습"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="country">결과</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="result" placeholder="결과">
                                </div>
							</div>
                            ...
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkExperienceInput2()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="experience2_list.php">
                    ...
                    <form name="form1" method="post" action="experience_check1.php">
                        <div class="container2">
                            ...
                            <div class="row">
                                <div class="col-25">
                                    <label for="lname">용어</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="word" placeholder="용어">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="country">용어 뜻</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="means" placeholder="용어 뜻">
                                </div>
							</div>
                            ...
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkExperienceInput1()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="experience1_list.php">
                                        <input type="button" value="목록">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="index.html">
