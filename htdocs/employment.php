    ...
    <body>
        ...
        <div id="testimonials" class="testimonials-section">
            <h2 class="section-title text-center" style="text-transform: capitalize;font-family:'Paragon Cleaners Medium' !important;">
                <font color="#000">Employment</font>
            </h2>
                ...
                <center>
                    <form name="form1" method="post" action="employment_check1.php">
                        <div class="container2">
                            ...
                            <div class="row">
                                <div class="col-25">
                                    <label for="lname">취업현황</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="employ_now" placeholder="취업현황">
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkEmploymentInput1()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="employment1_list.php">
					...
					<form name="form2" method="post" action="employment_check2.php">
                        <div class="container2">
							...
							<div class="row">
                                <div class="col-25">
                                    <label for="lname">홈페이지주소</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="website" placeholder="홈페이지 주소/없으면 공백">
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkEmploymentInput2()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="employment2_list.php">
                                        <input type="button" value="목록">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="index.html">
