                ...
                <center>
                    <form name="form1" method="post" action="location_check.php">
                        <div class="container2">
                            ...
                            <div class="row">
                                <div class="col-25">
                                    <label for="lname">대중교통(지하철)</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="subway" placeholder="대중교통(지하철)">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label for="country">대중교통(버스)</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" name="bus" placeholder="대중교통(버스)">
                                </div>
							</div>
							<div class="row">
                                <div class="col-25">
                                    <label for="subject">약도 이미지</label>
                                </div>
                                <div class="col-75">
                                    <input type="file" name="image_location" placeholder="약도 이미지">
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                    <br>
                                    <br>
                                    <a class="btn btn-cta" href="javascript:checkLocationInput1()">
                                        <input type="button" value="확인">
                                    </a>
                                    <br>
                                    <a class="btn btn-cta" href="location1_list.php">
